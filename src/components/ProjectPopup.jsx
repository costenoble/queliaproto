...
const ProjectPopup = ({ poi }) => {
  ...
  return (
    <div className="w-[480px] max-w-[92vw] bg-white font-sans rounded-2xl shadow-2xl max-h-[85vh] flex flex-col overflow-hidden">
      {/* Barre de couleur */}
      ...
      <div className="overflow-y-auto overflow-x-hidden flex-1 p-5 space-y-3">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          {poi.poi_logo_url && (
            <div className="bg-gray-50 rounded-lg p-2.5 border border-gray-200 shadow-sm flex-shrink-0 max-w-[160px]">
              <img
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-3 border border-green-200">
            <div className="flex items-center gap-1.5 mb-1 flex-wrap">
              <span className="text-xs text-gray-600 font-medium">Temps réel</span>
        ...
        {/* Voitures */}
        {carsCount !== null && (
          <div className="flex items-center justify-center gap-2 text-xs text-gray-600 bg-blue-50 rounded-lg p-2.5 border border-blue-100">
